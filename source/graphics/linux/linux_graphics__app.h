...
Function S8            LINUX_GLS8FromGLError (GLenum error);
Function S8            LINUX_GLS8FromGLError (GLenum error);
Function LINUX_GLProc *LINUX_GLProcLoad      (char *function);
#if Build_ModeDebug
void APIENTRY          LINUX_GLDebugOutput   (GLenum source, GLenum type, unsigned int id, GLenum severity, GLsizei length, const char *message, const void *user_data);
#endif
