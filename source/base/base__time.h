...
static T_DenseTime T_DenseTimeFromDateTime(T_DateTime date_time);
static T_DateTime T_DateTimeFromDenseTime(T_DenseTime dense_time);
...
static S8 T_S8FromDateTime(M_Arena *arena, T_DateTime date_time);
static S8 T_S8FromDenseTime(M_Arena *arena, T_DenseTime dense_time);