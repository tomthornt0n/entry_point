...
echo ~~~~~~~~~~~ debug build ~~~~~~~~~~~
set compile_options= /DUNICODE /D_UNICODE /DBuild_ModeDebug=1 /DBuild_UseSSE3=1 /DBuild_EnableAsserts=1 /DBuild_ZLib=1
...
echo ~~~~~~~~~~ release build ~~~~~~~~~~
set compile_options= /DUNICODE /D_UNICODE /DBuild_ModeRelease=1 /DBuild_NoCRT=1 /DBuild_UseSSE3=1 /DBuild_EnableAsserts=0 /DBuild_ZLib=1
